...
public class FragmentAdapter extends FragmentPagerAdapter {
     ...
     * @param title    The title of this fragment that will be shown in the Tabs
     */
     ...
     *
     * @param viewPagerId      The ID of this ViewPager
     * @param fragmentPosition The position of the fragment
     * @return The Tag associated with the fragment at the current position
     */
